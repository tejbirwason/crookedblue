	...
	$(".newsletter form").submit(function (event) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				if (data == "success")
					status.html("Thanks for your interest! <strong>Share</strong> to get to the front of the queue.").slideDown();
					...
					status.toggleClass('shake').html("Woops, something went wrong!").slideDown();	
				
			},
			error: function () {
				status.toggleClass('shake').html("Woops, something is wrong!").slideDown();
			}
		});
	});
